...
xClassifyCARET <- function(df_predictor, GSP, GSN, algorithm=c("glm","bayesglm","glmnet","lda","rda","pls","svmRadial","knn","nnet", "gbm","xgbLinear","xgbTree","LogitBoost","cforest","rf","myrf"), nfold=3, nrepeat=10, seed=825, cv.aggregateBy=c("none","logistic","Ztransform","fishers","orderStatistic"), verbose=TRUE)
{
