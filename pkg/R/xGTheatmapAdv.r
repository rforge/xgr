#' Function to plot tree and heatmap given associated data on tree tips
#'
#' \code{xGTheatmapAdv} is supposed to plot tree and heatmap given associated data on tree tips. It returns an object of class "ggplot".
#'
