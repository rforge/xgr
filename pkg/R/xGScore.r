...
#'
#' \code{xGScore} is supposed to extract genomic scores given a list of genomic regions. Scores for genomic positions can be numeric values for constraint/conservation or impact/pathogenicity on variation on positions. It returns a GR object
#'
