...
#' @param anno.identity identity for gene annotations. It can be "GeneID" for Gene ID and "Symbol" for gene symbol
...
xDefineOntology <- function(ontology=c(NA,"GOBP","GOMF","GOCC","PSG","PS","PS2","SF","Pfam","DO","HPPA","HPMI","HPCM","HPMA","MP", "EF", "MsigdbH", "MsigdbC1", "MsigdbC2CGP", "MsigdbC2CPall", "MsigdbC2CP", "MsigdbC2KEGG", "MsigdbC2REACTOME", "MsigdbC2BIOCARTA", "MsigdbC3TFT", "MsigdbC3MIR", "MsigdbC4CGN", "MsigdbC4CM", "MsigdbC5BP", "MsigdbC5MF", "MsigdbC5CC", "MsigdbC6", "MsigdbC7", "DGIdb", "GTExV4", "GTExV6p", "GTExV7", "CreedsDisease", "CreedsDiseaseUP", "CreedsDiseaseDN", "CreedsDrug", "CreedsDrugUP", "CreedsDrugDN", "CreedsGene", "CreedsGeneUP", "CreedsGeneDN", "KEGG","KEGGmetabolism","KEGGgenetic","KEGGenvironmental","KEGGcellular","KEGGorganismal","KEGGdisease", "REACTOME", "REACTOME_ImmuneSystem", "REACTOME_SignalTransduction", "CGL", "SIFTS2GOBP","SIFTS2GOMF","SIFTS2GOCC", "EnrichrAchillesFitnessD","EnrichrAchillesFitnessI","EnrichrARCHS4Cells","EnrichrARCHS4Tissues","EnrichrBioCarta","EnrichrChEA","EnrichrConsensusTFs","EnrichrdbGaP","EnrichrDSigDB","EnrichrEncodeTF","EnrichrHumanGeneAtlas","EnrichrhuMAP","EnrichrJensenDiseases","EnrichrJensenTissues","EnrichrKEGG","EnrichrNCIpathway","EnrichrOMIM","EnrichrOMIMexpanded","EnrichrPanther","EnrichrReactome","EnrichrTFlof","EnrichrTFpert","EnrichrTissueHumanProteomeMap","EnrichrTissueProteomicsDB","EnrichrWikiPathways"), anno.identity=c("GeneID","Symbol"), verbose=T, RData.location="http://galahad.well.ox.ac.uk/bigdata")
{
